export const strings = {
  ...
  welcomeMessage:
    "Welcome to the Legislator Analysis webpage. Here, we have performed an analysis on a dataset containing information about legislators, bills, votes, and vote results. We have answered the following questions based on the dataset:",
  question1: {
    question:
